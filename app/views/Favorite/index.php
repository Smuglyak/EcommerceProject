...
<head>
	<title><?= _("Favorite Food List") ?></title>
...
<body>
	...
	<div class="container py-3">
		<div class="hNav" style="padding-bottom: 20px">
			<h3><a href="/Account/index"><?= _("Account") ?></a></h3>
					...
					<div class="col-sm-3">
						<div class="card" style="margin-bottom: 50px; width:300px">
							...
							<div class="card-body text-center">
								...
								<a class="btn themeButton" href='/Favorite/deleteFavorite/<?php echo $food->favorite_id ?>'><?= _("Remove from Favorite") ?><i class='bi-trash'></i></a>
							</div>
